        ...
        <AnimatePresence mode="wait">
          {!isVerifying ? (
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className={styles.formGroup}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                    ...
                    <Link href="/auth/forgot-password" className={styles.link} style={{ fontSize: "13px" }}>Forgot?</Link>
                  </div>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, x: -20 }}
            >
              <h2 className={styles.title} style={{ fontSize: "22px" }}>Check your email</h2>
              ...
              <p className={styles.footerText}>
                Didn't receive it? <a href="#" className={styles.link} onClick={() => setIsVerifying(false)}>Resend</a>
              </p>
            </motion.div>
          )}
        </AnimatePresence>
